    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <form method="POST"
                ...
                <button type="submit"
                        data-confirm="Delete ALL activity logs permanently? This removes the complete audit trail, not only the currently filtered records. This cannot be undone."
                        data-confirm-title="Delete all activity logs"
                        data-confirm-button="Delete All Permanently"
