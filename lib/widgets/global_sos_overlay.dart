...
class GlobalSosOverlay extends StatefulWidget {
  ...
  static Future<void> open(BuildContext context) async {
    ...
    final ancestor = context.findAncestorStateOfType<_GlobalSosOverlayState>();
  ...
  Future<void> _beginSosFlow(BuildContext launchContext) async {
    ...
    try {
      ...
      final result = await showModalBottomSheet<MobileSosSendResult>(
        ...
        builder: (_) => _MobileSosForm(authService: AuthService()),
      );
  ...
  Future<void> _acquireLocation() async {
    ...
    try {
      ...
      setState(() {
        ...
        _locating = false;
        _locationError =
            'Unable to determine your location. Retry before sending.';
      });
    }
  }
          ...
          return Form(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                const Row(
                  children: <Widget>[
                    Icon(Icons.sos_rounded, color: Color(0xFFDC2626), size: 30),
                    SizedBox(width: 10),
                    Expanded(
                      child: Text(
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText:
                        'Describe what happened and what help is needed...',
      ...
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                const Icon(Icons.location_on_rounded, color: Color(0xFF047857)),
