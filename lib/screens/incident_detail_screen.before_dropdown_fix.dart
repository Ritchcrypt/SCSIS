...
class _IncidentDetailScreenState extends State<IncidentDetailScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      final agencies = _mapList(options['agencies']);
      ...
      setState(() {
        ...
        _selectedStatusId =
            _toInt(incident['status_id']) ??
            (statuses.isNotEmpty ? _toInt(statuses.first['id']) : null);

        _selectedResponder = '__keep__';

        _selectedAgency = agencies.isNotEmpty
            ? agencies.first['value']?.toString()
            : null;
  ...
  Widget _buildUpdateIncidentSection() {
    final statuses = _mapList(_options['statuses']);
    final responders = _mapList(_options['responders']);
  ...
  Widget _buildEscalationSection() {
    final agencies = _mapList(_options['agencies']);
