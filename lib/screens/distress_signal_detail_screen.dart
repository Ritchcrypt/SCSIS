  ...
  Future<void> _changeState(
    ...
    try {
      ...
      ScaffoldMessenger.of(context)
        ..hideCurrentSnackBar()
        ..showSnackBar(
          const SnackBar(content: Text('Unable to update the distress signal.')),
        );
    }
  }
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        _Field(
                          ...
                          value: _text(_alert['contact_number'], 'Not provided'),
                          emphasize: true,
                        ),
                        const SizedBox(height: 14),
                        _Field(
  ...
  Widget _locationCard(ThemeData theme) {
    ...
    if (latitude == null || longitude == null) {
      return const _SectionCard(
        title: 'Location',
        child: Text('Location is unavailable for this earlier distress signal.'),
      );
    }
...
class _Field extends StatelessWidget {
  const _Field({required this.label, required this.value, this.emphasize = false});
